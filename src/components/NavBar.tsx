...
export function NavBarFlowbite() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full md:hidden transition-all duration-200 ${
...
function NavItem({
  ...
  return (
    <Link href={href} passHref legacyBehavior>
      <Navbar.Link
        active={isActive}
        className={`md:text-xl block py-2 px-4 rounded-sm mb-2 md:mb-0 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 text-gray-900 ${
          isActive
